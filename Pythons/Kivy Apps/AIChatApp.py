...
from kivy.uix.screenmanager import ScreenManager,Screen,Image
...
class ChatPage(FloatLayout):
    def __init__(self,**kwargs):
        ...
        self.input_panel = BoxLayout(
            ...
            height=dp(48),
            pos_hint={'x': 0, 'y': 0} # Initially at bottom
        )
